...
// Se attivi la riga sottostante attivi anche il plugin postcss-hexrgba
...
// Se attivi le righe sottostanti minimizzi il css 
//   config.optimization = {
//     splitChunks: { chunks: "all" },
//     minimize: true,
//     minimizer: [`...`, new CssMinimizerPlugin()]
//   }
  config.plugins.push(new MiniCssExtractPlugin({ filename: "styles.[chunkhash].css" }), new RunAfterCompile())
}
